...
export default function Account() {
  ...
  return (
    <main className="min-h-screen bg-[#f3f2ed] pb-8 text-[#0a285a]">
      <header className="border-b border-[#d5dfeb] bg-[#f3f2ed]/95 backdrop-blur-xl"><div className="container flex h-[76px] items-center justify-between gap-4"><a href={appPath("/")} className="flex items-center" aria-label="Back to NetLet home"><img src={logoImage} alt="NetLet" className="h-11 w-auto max-w-[140px] object-contain" /></a><a href={appPath("/")} className="type-control pressable flex items-center gap-1.5 rounded-full border border-[#d5dfeb] bg-white px-4 py-2 text-[#0a285a] hover:bg-[#e7edf5]">Continue shopping <ChevronRight className="size-4" /></a></div></header>
